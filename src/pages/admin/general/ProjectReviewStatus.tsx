...
export default function ProjectReviewStatus() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<{ isOpen: boolean; item: ReviewStatus | null }>({
    isOpen: false,
    item: null,
  })
  ...
  const openDeleteConfirm = (item: ReviewStatus) => {
        ...
        >
          ...
          >
            ...
            <p className="text-gray-700 mb-6">
              Are you sure you want to delete <strong>{deleteConfirm.item.projectName}</strong>? This action cannot be undone.
            </p>
